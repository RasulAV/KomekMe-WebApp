...
class Auth extends Component {
    ...
    inputChangedHandler = (event, controlName) => {
        ...
        if (isEquelTo && this.state.isSignup) {
    ...
    render() {
        ...
        form = formElementsArray.map(formElement => {
            return this.state.isSignup ? formElementConstructor(formElement) :
                            ...
                            <MDBCard style={{ width: "25rem", marginTop: "3rem" }}>
                                <MDBCardBody>
                                    ...
                                    <form
                                        ...
                                        noValidate
                                    >
                                        <p className="h4 text-center py-4">{this.state.isSignup ? 'Sign Up' : 'Sign In'}</p>
                                        ...
                                        <div className="text-center py-4 mt-3">
                                            ...
                                            > {this.state.isSignup ? 'Register' : 'Log In'} </Button>
                                        </div>
                                    </form>
